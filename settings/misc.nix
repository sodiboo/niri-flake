...
[
  ...
  {
    options.cursor = make-rendered-section "cursor" { partial = true; } [
      {
      ...
      {
        extra-modules = [ (lib.mkRenamedOptionModule [ "hide-on-key-press" ] [ "hide-when-typing" ]) ];
  ...
  {
    extra-modules = [ (lib.mkRenamedOptionModule [ "screenshot-path" ] [ "screenshot" "path" ]) ];
  ...
  {
    options.hotkey-overlay = make-rendered-section "hotkey-overlay" { partial = true; } [
      {
  ...
  {
    options.config-notification = make-rendered-section "config-notification" { partial = true; } [
      {
  ...
  {
    options.clipboard = make-rendered-section "clipboard" { partial = true; } [
      {
  ...
  }
  {
    options.xwayland-satellite =
      make-rendered-section "xwayland-satellite"
        {
          partial = true;
          description = ''
